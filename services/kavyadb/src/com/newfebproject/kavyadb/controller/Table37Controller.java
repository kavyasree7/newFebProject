...
import com.newfebproject.kavyadb.service.Table37Service;
...
public class Table37Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table37 getTable37(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table37 editTable37(@PathVariable("id") Integer id, @RequestBody Table37 table37) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable37(@PathVariable("id") Integer id) throws EntityNotFoundException {
