...
import com.newfebproject.viewsdb.NewTable;
import com.newfebproject.viewsdb.service.NewTableService;
...
public class NewTableController {
	...
	@ApiOperation(value = "Creates a new NewTable instance.This API should be used when the NewTable instance has fields that requires multipart data.")
	@RequestMapping(method = RequestMethod.POST, consumes = {"multipart/form-data"})
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public NewTable createNewTable(MultipartHttpServletRequest multipartHttpServletRequest) {
    	NewTable newTable = WMMultipartUtils.toObject(multipartHttpServletRequest, NewTable.class, "viewsdb"); 
        LOGGER.debug("Creating a new NewTable with information: {}" , newTable);
        return newTableService.create(newTable);
    }
