...
public interface EmployeeService {
    ...
    /*
     * Returns the associated empPhotos for given Employee id.
     *
     * @param empno value of empno; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated EmpPhoto instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<EmpPhoto> findAssociatedEmpPhotos(String empno, Pageable pageable);

    /*
     * Returns the associated departmentsForMgrno for given Employee id.
     *
     * @param empno value of empno; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Department instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<Department> findAssociatedDepartmentsForMgrno(String empno, Pageable pageable);

    /*
     * Returns the associated empResumes for given Employee id.
     *
     * @param empno value of empno; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated EmpResume instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<EmpResume> findAssociatedEmpResumes(String empno, Pageable pageable);

    /*
     * Returns the associated projects for given Employee id.
     *
     * @param empno value of empno; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Project> findAssociatedProjects(String empno, Pageable pageable);
