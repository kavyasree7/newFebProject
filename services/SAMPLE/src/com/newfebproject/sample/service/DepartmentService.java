...
public interface DepartmentService {
	 ...
	 */
	Department getById(String departmentId) throws EntityNotFoundException;
	 ...
	 */
	Department delete(String departmentId) throws EntityNotFoundException;
    ...
    /*
     * Returns the associated departmentsForAdmrdept for given Department id.
     *
     * @param deptno value of deptno; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Department> findAssociatedDepartmentsForAdmrdept(String deptno, Pageable pageable);

    /*
     * Returns the associated employeesForWorkdept for given Department id.
     *
     * @param deptno value of deptno; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Employee> findAssociatedEmployeesForWorkdept(String deptno, Pageable pageable);

    /*
     * Returns the associated projects for given Department id.
     *
     * @param deptno value of deptno; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Project> findAssociatedProjects(String deptno, Pageable pageable);
