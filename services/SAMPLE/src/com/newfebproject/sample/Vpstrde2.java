...
/**
 * Vpstrde2 generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`VPSTRDE2`")
@IdClass(Vpstrde2Id.class)
public class Vpstrde2 implements Serializable {
    ...
    @Id
    @Column(name = "`PROJ1NO`", nullable = false, length = 6)
    ...
    @Id
    @Column(name = "`PROJ1NAME`", nullable = false, length = 24)
    ...
    @Id
    @Column(name = "`RESP1NO`", nullable = false, length = 6)
    ...
    @Id
    @Column(name = "`RESP1FN`", nullable = false, length = 12)
    ...
    @Id
    @Column(name = "`RESP1MI`", nullable = true, length = 1)
    ...
    @Id
    @Column(name = "`RESP1LN`", nullable = false, length = 15)
    ...
    @Id
    @Column(name = "`PROJ2NO`", nullable = false, length = 6)
    ...
    @Id
    @Column(name = "`PROJ2NAME`", nullable = false, length = 24)
    ...
    @Id
    @Column(name = "`RESP2NO`", nullable = false, length = 6)
    ...
    @Id
    @Column(name = "`RESP2FN`", nullable = false, length = 12)
    ...
    @Id
    @Column(name = "`RESP2MI`", nullable = true, length = 1)
    ...
    @Id
    @Column(name = "`RESP2LN`", nullable = false, length = 15)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Vpstrde2)) return false;
        final Vpstrde2 vpstrde2 = (Vpstrde2) o;
        return Objects.equals(getProj1no(), vpstrde2.getProj1no()) &&
                Objects.equals(getProj1name(), vpstrde2.getProj1name()) &&
                Objects.equals(getResp1no(), vpstrde2.getResp1no()) &&
                Objects.equals(getResp1fn(), vpstrde2.getResp1fn()) &&
                Objects.equals(getResp1mi(), vpstrde2.getResp1mi()) &&
                Objects.equals(getResp1ln(), vpstrde2.getResp1ln()) &&
                Objects.equals(getProj2no(), vpstrde2.getProj2no()) &&
                Objects.equals(getProj2name(), vpstrde2.getProj2name()) &&
                Objects.equals(getResp2no(), vpstrde2.getResp2no()) &&
                Objects.equals(getResp2fn(), vpstrde2.getResp2fn()) &&
                Objects.equals(getResp2mi(), vpstrde2.getResp2mi()) &&
                Objects.equals(getResp2ln(), vpstrde2.getResp2ln());
    }
