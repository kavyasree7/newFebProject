...
import com.newfebproject.sample.service.OrgService;
 ...
 * @see Org
 */
@RestController("SAMPLE.OrgController")
...
public class OrgController {
    ...
    @ApiOperation(value = "Returns the Org instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Org getOrg(@RequestParam("deptnumb") Short deptnumb,@RequestParam("deptname") String deptname,@RequestParam("manager") Short manager,@RequestParam("division") String division,@RequestParam("location") String location) throws EntityNotFoundException {

        OrgId orgId = new OrgId();
        orgId.setDeptnumb(deptnumb);
        orgId.setDeptname(deptname);
        orgId.setManager(manager);
        orgId.setDivision(division);
        orgId.setLocation(location);

        LOGGER.debug("Getting Org with id: {}" , orgId);
    ...
    @ApiOperation(value = "Updates the Org instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Org editOrg(@RequestParam("deptnumb") Short deptnumb,@RequestParam("deptname") String deptname,@RequestParam("manager") Short manager,@RequestParam("division") String division,@RequestParam("location") String location, @RequestBody Org org) throws EntityNotFoundException {

        org.setDeptnumb(deptnumb);
        org.setDeptname(deptname);
        org.setManager(manager);
        org.setDivision(division);
        org.setLocation(location);

        LOGGER.debug("Org details with id is updated with: {}" , org);

        return orgService.update(org);
    }


    @ApiOperation(value = "Deletes the Org instance associated with the given composite-id.")
    @RequestMapping(value = "/composite-id", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteOrg(@RequestParam("deptnumb") Short deptnumb,@RequestParam("deptname") String deptname,@RequestParam("manager") Short manager,@RequestParam("division") String division,@RequestParam("location") String location) throws EntityNotFoundException {
        ...
        Org org = orgService.delete(orgId);
    ...
    public Page<Org> searchOrgsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Orgs list");
