...
import com.newfebproject.sample.service.EmployeeService;
 ...
 * @see Employee
 */
@RestController("SAMPLE.EmployeeController")
...
public class EmployeeController {
    ...
    public Employee editEmployee(@PathVariable("id") String id, @RequestBody Employee employee) throws EntityNotFoundException {
        LOGGER.debug("Editing Employee with id: {}" , employee.getEmpno());
    ...
    @RequestMapping(value="/{id:.+}/empPhotos", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the empPhotos instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<EmpPhoto> findAssociatedEmpPhotos(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated empPhotos");
        return employeeService.findAssociatedEmpPhotos(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/departmentsForMgrno", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the departmentsForMgrno instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Department> findAssociatedDepartmentsForMgrno(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated departmentsForMgrno");
        return employeeService.findAssociatedDepartmentsForMgrno(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/empResumes", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the empResumes instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<EmpResume> findAssociatedEmpResumes(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated empResumes");
        return employeeService.findAssociatedEmpResumes(id, pageable);
    }
    ...
    public Page<Project> findAssociatedProjects(@PathVariable("id") String id, Pageable pageable) {
        ...
        return employeeService.findAssociatedProjects(id, pageable);
    }
