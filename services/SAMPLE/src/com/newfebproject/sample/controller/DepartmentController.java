...
import com.newfebproject.sample.service.DepartmentService;
...
public class DepartmentController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Department getDepartment(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Department editDepartment(@PathVariable("id") String id, @RequestBody Department department) throws EntityNotFoundException {
        LOGGER.debug("Editing Department with id: {}" , department.getDeptno());
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteDepartment(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    @RequestMapping(value="/{id:.+}/departmentsForAdmrdept", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the departmentsForAdmrdept instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Department> findAssociatedDepartmentsForAdmrdept(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated departmentsForAdmrdept");
        return departmentService.findAssociatedDepartmentsForAdmrdept(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/employeesForWorkdept", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the employeesForWorkdept instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Employee> findAssociatedEmployeesForWorkdept(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated employeesForWorkdept");
        return departmentService.findAssociatedEmployeesForWorkdept(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/projects", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the projects instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Project> findAssociatedProjects(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated projects");
        return departmentService.findAssociatedProjects(id, pageable);
    }
