...
package com.newfebproject.newtestdatabase.service;
...
import com.newfebproject.newtestdatabase.Table1;
 ...
 * @see Table1
 */
@Service("newtestDatabase.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("newtestDatabase.Table1Dao")
    ...
    @Transactional(value = "newtestDatabaseTransactionManager")
    @Override
	...
	@Transactional(readOnly = true, value = "newtestDatabaseTransactionManager")
	@Override
	...
	@Transactional(rollbackFor = EntityNotFoundException.class, value = "newtestDatabaseTransactionManager")
	@Override
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service newtestDatabase for table Table1 to {} format", exportType);
