...
/**
 * UdBothIuWithOutValues generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`UD Both IU WithOut Values`")
public class UdBothIuWithOutValues implements Serializable {
    ...
    @Column(name = "`Double Column`", nullable = true, scale = 6, precision = 18)
    ...
    @Column(name = "`Float Column`", nullable = true, scale = 5, precision = 9)
    ...
    @Column(name = "`String Column`", nullable = true, length = 15)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UdBothIuWithOutValues)) return false;
        final UdBothIuWithOutValues udBothIuWithOutValues = (UdBothIuWithOutValues) o;
        return Objects.equals(getIdCol(), udBothIuWithOutValues.getIdCol());
    }
