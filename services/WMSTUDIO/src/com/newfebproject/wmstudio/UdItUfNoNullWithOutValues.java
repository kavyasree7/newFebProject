...
/**
 * UdItUfNoNullWithOutValues generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`UD_IT_UF NoNull WithOut Values`")
public class UdItUfNoNullWithOutValues implements Serializable {
    ...
    @Column(name = "`Integer Column`", nullable = false, scale = 0, precision = 10)
    ...
    @Column(name = "`Double Column`", nullable = false, scale = 8, precision = 17)
    ...
    @Column(name = "`Float Column`", nullable = false, scale = 4, precision = 6)
    ...
    @Column(name = "`Short Column`", nullable = false, scale = 0, precision = 5)
    ...
    @Column(name = "`BigDecimal Column`", nullable = false, scale = 18, precision = 38)
    ...
    @Column(name = "`String Column`", nullable = false, length = 80)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UdItUfNoNullWithOutValues)) return false;
        final UdItUfNoNullWithOutValues udItUfNoNullWithOutValues = (UdItUfNoNullWithOutValues) o;
        return Objects.equals(getId(), udItUfNoNullWithOutValues.getId());
    }
