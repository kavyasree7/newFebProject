...
/**
 * UdUpdatableWithValues generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`UD Updatable With Values`")
public class UdUpdatableWithValues implements Serializable {
    ...
    @Column(name = "`Double Column`", nullable = true, scale = 6, precision = 17)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UdUpdatableWithValues)) return false;
        final UdUpdatableWithValues udUpdatableWithValues = (UdUpdatableWithValues) o;
        return Objects.equals(getIdCol(), udUpdatableWithValues.getIdCol());
    }
