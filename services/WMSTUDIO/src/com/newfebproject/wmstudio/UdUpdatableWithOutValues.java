...
/**
 * UdUpdatableWithOutValues generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`UD Updatable WithOut Values`")
public class UdUpdatableWithOutValues implements Serializable {
    ...
    @Column(name = "`String Column`", nullable = true, length = 25)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UdUpdatableWithOutValues)) return false;
        final UdUpdatableWithOutValues udUpdatableWithOutValues = (UdUpdatableWithOutValues) o;
        return Objects.equals(getIdCol(), udUpdatableWithOutValues.getIdCol());
    }
