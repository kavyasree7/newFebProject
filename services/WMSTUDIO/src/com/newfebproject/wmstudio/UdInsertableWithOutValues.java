...
/**
 * UdInsertableWithOutValues generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`UD Insertable WithOut Values`")
public class UdInsertableWithOutValues implements Serializable {
    ...
    private Double bigDecimalColumn;
    ...
    @Column(name = "`Double Column`", nullable = true, scale = 9, precision = 18)
    ...
    @Column(name = "`Float Column`", nullable = true, scale = 4, precision = 8)
    ...
    @Column(name = "`BigDecimal Column`", nullable = true, scale = 6, precision = 18)
    public Double getBigDecimalColumn() {
        return this.bigDecimalColumn;
    }

    public void setBigDecimalColumn(Double bigDecimalColumn) {
    ...
    @Column(name = "`String Column`", nullable = true, length = 10)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UdInsertableWithOutValues)) return false;
        final UdInsertableWithOutValues udInsertableWithOutValues = (UdInsertableWithOutValues) o;
        return Objects.equals(getIdCol(), udInsertableWithOutValues.getIdCol());
    }
