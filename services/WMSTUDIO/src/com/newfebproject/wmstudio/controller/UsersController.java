...
import com.newfebproject.wmstudio.service.UsersService;
 ...
 * @see Users
 */
@RestController("WMSTUDIO.UsersController")
@Api(value = "UsersController", description = "Exposes APIs to work with Users resource.")
@RequestMapping("/WMSTUDIO/Users")
public class UsersController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UsersController.class);

    @Autowired
	@Qualifier("WMSTUDIO.UsersService")
    ...
    public Page<SalaryDetails> findAssociatedSalaryDetailses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return usersService.findAssociatedSalaryDetailses(id, pageable);
    }
