...
import com.newfebproject.wmstudio.service.JobHistoryService;
...
public class JobHistoryController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public JobHistory getJobHistory(@RequestParam("employeeId") Integer employeeId,@RequestParam("startDate") LocalDateTime startDate) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public JobHistory editJobHistory(@RequestParam("employeeId") Integer employeeId,@RequestParam("startDate") LocalDateTime startDate, @RequestBody JobHistory jobHistory) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteJobHistory(@RequestParam("employeeId") Integer employeeId,@RequestParam("startDate") LocalDateTime startDate) throws EntityNotFoundException {
    ...
    public Page<JobHistory> searchJobHistoriesByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering JobHistories list");
