...
import com.newfebproject.wmstudio.service.RegionsService;
...
public class RegionsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Regions getRegions(@PathVariable("id") BigInteger id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Regions editRegions(@PathVariable("id") BigInteger id, @RequestBody Regions regions) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteRegions(@PathVariable("id") BigInteger id) throws EntityNotFoundException {
