...
import com.newfebproject.wmstudio.AllTypes;
import com.newfebproject.wmstudio.service.AllTypesService;
...
public class AllTypesController {
    ...
    public AllTypes editAllTypes(@PathVariable("id") Integer id, @RequestBody AllTypes allTypes) throws EntityNotFoundException {
        LOGGER.debug("Editing AllTypes with id: {}" , allTypes.getPkColumn());

        allTypes.setPkColumn(id);
