...
/**
 * UdInsertableWithValues generated by WaveMaker Studio.
 */
@Entity
@Table(name = "`UD Insertable With Values`")
public class UdInsertableWithValues implements Serializable {
    ...
    @Column(name = "`Double Column`", nullable = true, scale = 7, precision = 18)
    ...
    @Column(name = "`BigDecimal Column`", nullable = true, scale = 18, precision = 38)
    ...
    @Column(name = "`String Column`", nullable = true, length = 35)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UdInsertableWithValues)) return false;
        final UdInsertableWithValues udInsertableWithValues = (UdInsertableWithValues) o;
        return Objects.equals(getIdCol(), udInsertableWithValues.getIdCol());
    }
